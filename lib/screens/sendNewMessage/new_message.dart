                    ...
                    children: [
                      ...
                      isLoading
                        ...
                        itemBuilder: (BuildContext context, int index) {
                         ...
                         var s = chatUsers![index].group;
                          return chatUsers![index].group==false?
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 200),
                        child: Image.network("https://messaging.care/assets/media/avatars/msg.png",width: 400,fit: BoxFit.fitHeight,),
                      )),
...
contentPadding: EdgeInsets.symmetric(horizontal: 10,vertical: 20),isDense: true
                                          ),
                                        ),
                                      ),
                                    ),
